 ...
 *    from index 0 to NPS - 1, using the functions defined in import.h to find the
 *    first unallocated page with usable permission.
 ...
 *    scan the allocation table from index 0 every time.
 */
unsigned int
palloc()
{
