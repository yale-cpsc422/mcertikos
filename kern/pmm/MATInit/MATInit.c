...
void pmem_init(unsigned int mbi_addr)
{
     ...
     *    Currently, we do not utilize partial pages, so in that case, you should consider those pages as unavailable.
     * 4. Every page in the allocation table should be initialized.
     *    But the ranges in the memory map table may not cover the entire available address space.
