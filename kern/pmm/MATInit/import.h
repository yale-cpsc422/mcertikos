 ...
 * E.g., A row (10000, 1000, 1) represents that the physical address range (10000, 11000) is available for the kernel,
...
unsigned int is_usable(unsigned int);  // Whether the range with given row index is usable by the kernel. (0: reserved, 1: useable)
