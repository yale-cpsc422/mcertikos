...
static gcc_inline void insb(int port, void *addr, int cnt)
{
...
static gcc_inline uint16_t inw(int port)
{
    uint16_t data;
...
static gcc_inline void insw(int port, void *addr, int cnt)
{
    __asm __volatile ("cld\n\trepne\n\tinsw"
                      : "=D" (addr), "=c" (cnt)
                      : "d" (port), "0" (addr), "1" (cnt)
...
static gcc_inline uint32_t inl(int port)
{
    uint32_t data;
...
static gcc_inline void insl(int port, void *addr, int cnt)
{
    __asm __volatile ("cld\n\trepne\n\tinsl"
                      : "=D" (addr), "=c" (cnt)
                      : "d" (port), "0" (addr), "1" (cnt)
...
static gcc_inline void outb(int port, uint8_t data)
{
    __asm __volatile ("outb %0,%w1" :: "a" (data), "d" (port));
}

static gcc_inline void outsb(int port, const void *addr, int cnt)
{
    __asm __volatile ("cld\n\trepne\n\toutsb"
                      : "=S" (addr), "=c" (cnt)
                      : "d" (port), "0" (addr), "1" (cnt)
...
static gcc_inline void outw(int port, uint16_t data)
{
    __asm __volatile ("outw %0,%w1" :: "a" (data), "d" (port));
}

static gcc_inline void outsw(int port, const void *addr, int cnt)
{
    __asm __volatile ("cld\n\trepne\n\toutsw"
                      : "=S" (addr), "=c" (cnt)
                      : "d" (port), "0" (addr), "1" (cnt)
...
static gcc_inline void outsl(int port, const void *addr, int cnt)
{
    __asm __volatile ("cld\n\trepne\n\toutsl"
                      : "=S" (addr), "=c" (cnt)
                      : "d" (port), "0" (addr), "1" (cnt)
...
static gcc_inline void outl(int port, uint32_t data)
{
    __asm __volatile ("outl %0,%w1" :: "a" (data), "d" (port));
}

static gcc_inline void smp_wmb(void)
{
    __asm __volatile ("" ::: "memory");
}

static gcc_inline void smp_rmb(void)
{
    __asm __volatile ("" ::: "memory");
}

static gcc_inline uint64_t rdtsc(void)
{
    uint64_t rv;
...
static gcc_inline uint64_t rdtscp(void)
{
    uint64_t rv;
...
static gcc_inline void cpuid(uint32_t info, uint32_t * eaxp, uint32_t * ebxp,
...
static gcc_inline cpu_vendor vendor()
{
    uint32_t eax, ebx, ecx, edx;
    char cpuvendor[13];
...
static gcc_inline void cpuid_subleaf(uint32_t leaf, uint32_t subleaf, uint32_t * eaxp,
